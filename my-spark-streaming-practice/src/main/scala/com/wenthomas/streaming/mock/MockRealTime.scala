package com.wenthomas.streaming.mock

import java.util.Properties

import com.wenthomas.streaming.mock.bean.CityInfo
import com.wenthomas.streaming.mock.util.{RandomNumUtil, RandomOptions}
